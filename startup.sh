...
export KEY_STORE_PATH=../doc-checking/deploy/keys/acceptance_test_client_mutual_auth.jks
export TRUST_STORE_PATH=../doc-checking/deploy/keys/acceptance_test_client_mutual_auth.jks
...
export SSL_REQUEST_HEADER="/CN=ssl two"
export DCS_ENCRYPTION_CERT=../doc-checking/deploy/keys/dcs_licence_encryption.crt
