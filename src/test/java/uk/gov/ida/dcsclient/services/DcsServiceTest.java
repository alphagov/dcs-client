...
import static uk.gov.ida.dcsclient.services.DcsService.*;
...
public class DcsServiceTest {
    ...
    public void shouldPostJoseToDCS() throws Exception {
        ...
        when(requestBuilder.post(Entity.entity(payload, APPLICATION_MEDIA_TYPE_JOSE))).thenReturn(expectedResponse);
        ...
        verify(requestBuilder).header(COMMON_NAME_HEADER, sslRequestHeader);
    }
